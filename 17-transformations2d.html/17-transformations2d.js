...
function main() {
    ...
    window.onkeydown = function(event) {
	    ...
	    case 'R':
		    ...
		    t1=translate(.6, .6, 0.0);
		    r=rotate(15.0, 0.0, 0.0, 1.0);
		    t2=translate(-.6, -.6, 0.0);
            modelViewMatrix = mult(mult(mult(t2, r), t1), modelViewMatrix);
            break;
	    ...
	    case 'S':
		    ...
		    s=scale4(.7, .7, 0.0);
		    t2=translate(-.6, -.6, 0.0);
            modelViewMatrix = mult(mult(mult(t2, s), t1), modelViewMatrix);
		    break;

	    //Perform a scale up about the lower left corner of the white rectangle
	    case 'G':
		    t1=translate(.6, .6, 0.0);
		    s=scale4(1.2, 1.2, 0.0);
		    t2=translate(-.6, -.6, 0.0);
