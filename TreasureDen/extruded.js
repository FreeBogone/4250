 ...
 * CSCI 4250-D01
 *
 * Definitions and drawing functions for extruded shapes.
 */

// Vertices composing a face of cube.
const EXTRUDED_CUBE_VERTICES = [
	vec4(-1, 0, 1, 1),
	vec4(-1, 0, -1, 1),
	vec4(1, 0, -1, 1),
	vec4(1, 0, 1, 1),
...
// Extrusion black-magic demands texture coordinates specialized for the
// vertices generated by it, even if its just a cube!
const EXTRUDED_CUBE_TEX_COORDS = [
	[0, 0],
	[1, 0],
	[1, 1],
	[0, 1],
