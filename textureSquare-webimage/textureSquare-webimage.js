...
window.onload = function init() {
    ...
    // Tell the broswer to load an cross origin image
	texture.image.crossOrigin = '';  // or set to 'anonymous'
    //texture.image.src="http://i.imgur.com/3tU4Vig.jpg";
    texture.image.src="https://www.cs.mtsu.edu/~cen/sky.jpg"; 
	// The web server has to allow Cross-origin resource sharing CORS)
